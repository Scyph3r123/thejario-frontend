...
const Welcome = ({scrollToStart, data}) => {
    ...
    return (
        <div className='min-h-screen flex relative z-10' ref={banner}>
            ...
            src={`${basePath}${data.about.data.attributes.profile_picture.data.attributes.url}`} alt="Theja Rio" className=' pointer-events-none absolute z-0 w-[400px] -ml-[200px] md:w-[500px] left-1/2 md:-ml-[250px] top-1/2 -mt-[300px] md:-mt-[375px]' />
            <motion.div
